...
This program can be run through an IDE or can be run through terminal, where you can specify the number of workers
   you wish to spawn, using the following shell scripts:
